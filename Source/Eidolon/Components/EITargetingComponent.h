...
#include "EITargetingComponent.generated.h"

class UCameraComponent;

UCLASS( ClassGroup=(Custom), meta=(BlueprintSpawnableComponent) )
class EIDOLON_API UEITargetingComponent : public UActorComponent
{
	GENERATED_BODY()
...
protected:
	...
	/* 캐릭터가 카메라(Control Rotation) 의 회전에 동기화 되도록 설정 */
